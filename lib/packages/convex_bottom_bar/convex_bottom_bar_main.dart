    ...
    return Scaffold(
          ...
          children: <Widget>[
            ...
            CheckboxListTile(
              ...
              onChanged: (newValue) {
                setState(() {
                  _fiveItems = newValue!;
                  _tabbedTab = (_fiveItems ? _fiveTabItems[2].title! : _threeTabItems[1].title!);
                });
              },
            ...
            Container(
              ...
              child: Text(
                'Tab ' + _tabbedTab + ' is selected.',
                style: Theme.of(context).textTheme.headline6,
              ),
            ),
            PackageWeblinkView('convex_bottom_bar 3.0.0',
                'https://pub.dev/packages/convex_bottom_bar/example'),
            SizedBox(
              height: -_top,
            ),
          ],
      ...
      bottomNavigationBar: ConvexAppBar(
        ...
        onTap: (int i){
          setState(() {
            print(i);
            _tabbedTab = (_fiveItems ? _fiveTabItems[i].title! : _threeTabItems[i].title!);
          });
        },
